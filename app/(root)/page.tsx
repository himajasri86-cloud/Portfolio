...
export const metadata: Metadata = {
  ...
  description:
    "Himaja Sri - BBA Digital Technologies student at Mahindra University exploring product management, business and data analytics.",
  alternates: {
